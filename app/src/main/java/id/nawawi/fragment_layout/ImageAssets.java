...
public class ImageAssets {
    ...
    //    mengelompokkan asset jadi 1 group variabel heads
    ...
    //    mengelompokkan asset jadi 1 group variabel bodys
    ...
    //    mengelompokkan asset jadi 1 group variabel legs
    ...
    //    ini adalah method yang digunakan untuk memanggil/mengambil variabel heads
    public static List<Integer> getHeads(){
        return heads;
    }

    //    ini adalah method yang digunakan untuk memanggil/mengambil variabel bodys
    public static List<Integer> getBodys(){
        return bodys;
    }

    //    ini adalah method yang digunakan untuk memanggil/mengambil variabel legs
